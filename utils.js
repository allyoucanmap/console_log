...
const tags = {
    createEl: ['div', 'span', 'strong', 'link', 'canvas'],
    createNS: ['rect', 'circle', 'path', 'svg', 'g', 'foreignObject', 'text', 'use', 'tspan', 'line']
};
...
export function create(tag, attributes = {}, style = {}, parent) {
    const el = tags.createEl.indexOf(tag) !== -1
        ? document.createElement(tag)
        : tags.createNS.indexOf(tag) !== -1
